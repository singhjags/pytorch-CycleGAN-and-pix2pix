...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type = str, default = '/content/gdrive/My Drive/sydney_house_data', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
