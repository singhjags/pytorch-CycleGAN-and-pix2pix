...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', type = str, default = './CUHK', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
#        parser.add_argument('--dataroot', type = str, default = './sydney_house_data', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
